...
export default function KakaoCallbackPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-yellow-50 via-white to-yellow-100">
        ...
        <div className="flex flex-col items-center">
          {status === 'loading' && (
            <>
              ...
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">카카오 로그인 처리 중</h2>
