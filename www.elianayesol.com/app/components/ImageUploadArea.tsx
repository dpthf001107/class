          ...
          <div className="flex items-center justify-end gap-3 mt-6">
            ...
            {uploadedFile && (
              <Button
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (response.ok) {
                      ...
                      if (result.faceDetection?.completed || result.generalDetection?.completed || result.segmentation?.completed) {
                        router.push(`/upload/result?file=${encodeURIComponent(result.fileName)}`);
                      } else if (result.detectedFileName || result.faceDetectedFileName || result.segmentedFileName) {
                        router.push(`/upload/result?file=${encodeURIComponent(result.fileName)}`);
                      } else {
                ...
                className="px-6 bg-gradient-to-r from-blue-600 to-blue-400 text-white hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
